...
#
# Usage:
#   bash scripts/project_spec.sh           # Normal run
#   ADMIN_BOOTSTRAP_FORCE=1 bash scripts/project_spec.sh  # Force re-init
#
# =============================================================================
# CONFIGURATION
# =============================================================================
...
if [ -f "${BOOTSTRAP_LOCK_FILE}" ] && [ "${ADMIN_BOOTSTRAP_FORCE:-0}" != "1" ]; then
    ...
    echo "To force a rerun, execute: ADMIN_BOOTSTRAP_FORCE=1 bash scripts/project_spec.sh"
    exit 0
fi
