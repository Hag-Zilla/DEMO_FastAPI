...
class TestListExpenses:
    ...
    def test_list_expenses_pagination(
        ...
        response_page1 = authenticated_client.get("/expenses/?limit=2&offset=0")
        response_page2 = authenticated_client.get("/expenses/?limit=2&offset=2")
...
class TestUpdateDeleteExpense:
    ...
    def test_user_cannot_delete_others_expense(
        ...
        response = authenticated_client.delete(f"/expenses/{other_expense.id}")
        assert response.status_code == 404
